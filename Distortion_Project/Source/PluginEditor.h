...
private:
    ...
    mySlider DelayGainSlider;
    mySlider DelayAmountSlider;
    ...
    std::unique_ptr<SliderAttachments> DelayGainSliderAttachment;
    std::unique_ptr<SliderAttachments> DelayAmountSliderAttachment;
